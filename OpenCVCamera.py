...
cv.createTrackbar("Min Hue", SET_MASK_WINDOW, 90, 179, n)
cv.createTrackbar("Max Hue", SET_MASK_WINDOW, 140, 179, n)
cv.createTrackbar("Min Sat", SET_MASK_WINDOW, 74, 255, n)
cv.createTrackbar("Max Sat", SET_MASK_WINDOW, 255, 255, n)
cv.createTrackbar("Min Val", SET_MASK_WINDOW, 0, 255, n)
cv.createTrackbar("Max Val", SET_MASK_WINDOW, 255, 255, n)
...
while True:
    ...
    image = cv.imread('D:/Python IDLE/MyPythonProjects/OpenCV/Colors.png')
